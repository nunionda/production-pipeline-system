    ...
    <div>
      ...
      <div className="p-6">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          <StatCard label="시나리오" value={project._count.scripts} />
          <StatCard label="등장인물" value={project._count.characters} />
          <StatCard label="소품" value={project._count.props} />
          <StatCard label="로케이션" value={project._count.locations} />
